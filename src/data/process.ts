...
export const processList1UK = [
  {
    no: "1",
    className: "me-lg-6",
    title: "Особа віком від 18 років",
    subtitle: "",
    shadow: true
  },
  {
    no: "2",
    title: "Особа, що проживає на території Вармінсько-Мазурського воєводства",
    className: "me-lg-6 mt-6",
    shadow: true,
    subtitle: ""
  },
  ...
  {
    no: "4",
    title: "Особа, яка є економічно неактивною",
    className: "me-lg-6 mt-6",
    subtitle: "",
    shadow: true
  },
  ...
  {
    no: "6",
    title: "Громадяни третіх країн, зокрема мігранти та їхні родини",
    className: "me-lg-6 mt-6",
    subtitle: "",
    shadow: true
  },
